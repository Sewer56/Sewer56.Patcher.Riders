...
Write-Host "=== SRDX Patch Generator ===" -ForegroundColor Cyan
Write-Host ""
...
Test-RequiredFile "Assets\DX\Hashes\Original ROM\hashes.json" "Original ROM hashes"
Write-Host ""
...
Invoke-PatcherCli @("VerifyHashes", "--tgt", "Original", "--hash", "Assets\DX\Hashes\Original ROM")
...
$ModHashesDir = "Assets\DX\Hashes\DX ROM"
